...
class PerfilFormManager {
    ...
    static tipoCargoId() {
        const selectedOption = this.cargo.options[this.cargo.selectedIndex];
        return selectedOption ? selectedOption.getAttribute('data-tipo-cargo') : null;
    }
    ...
    static async handleSubmit(event) {
        ...
        const formData = {
            ...
            app_perfiles: appPerfilesSeleccionadosIds,
