...
/*       const prevContentEditCargo = this.getModalCargo.querySelector("#OpcionesInfraContent");
      ...
      const nombrePerfilInput = document.createElement("div");
      nombrePerfilInput.className = "mb-4";

      const nombreLabel = document.createElement("label");
      nombreLabel.className = "form-label";
      nombreLabel.htmlFor = "nombre-perfil";
      ...
      // crea el select2 para seleccionar aplicaciones
      ...
      selectAplicaciones.name = "aplicaciones-perfil";
      selectAplicaciones.dataset.placeholder = "Seleccione las aplicaciones..";

      aplicaciones.then(data => {
        data.aplicaciones.forEach(aplicacion => {
          const option = document.createElement("option");
          option.value = aplicacion.id;
          option.textContent = aplicacion.name;
          selectAplicaciones.appendChild(option);
        });
      });
      
      nombrePerfilInput.appendChild(nombreLabel);
      nombrePerfilInput.appendChild(nombreInput);
      newPerfilContent.appendChild(nombrePerfilInput);
      newPerfilContent.appendChild(selectAplicaciones);

      this.getModalPerfil.querySelector(".block-content").appendChild(newPerfilContent);
          ...
          <div class="btn-group">
            ${isActive ? `
              <button type="button" class="btn btn-sm btn-danger btn-inactive"
                ...
                data-cargo-id="${row.perfil_id}"
                data-cargo-nombre="${row.nombre_perfil}">
