...
@section('js')
    ...
    <script type="module">
        Codebase.helpersOnLoad(['jq-select2', 'jq-notify', 'jq-validation', 'jq-masked-inputs', 'js-flatpickr']);
    </script>
                ...
                <form id="main-form">
                    <div class="block block-themed block-rounded">
                        <div class="block-header">
                            <h3 class="block-title">Formulario de Solicitud</h3>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="row mb-4">
                                        <div class="col-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="num_factura"
                                                    name="num_factura" for="num_factura" placeholder="num_factura">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-6">
                                            <div class="form-floating">
                                                <input type="text" class="js-flatpickr form-control" id="fecha_inicio"
                                                    name="fecha_inicio" for="fecha_inicio" placeholder="d-m-Y"
                                        ...
                                        <div class="col-6">
                                            <div class="form-floating">
                                                <input type="text" class="js-flatpickr form-control" id="fecha_final"
                                                    name="fecha_final" for="fecha_final" placeholder="d-m-Y"
                                                    data-date-format="d-m-Y">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="v_copago" name="v_copago"
                                                    for="v_copago" placeholder="Valor Copago">
                                                <label class="form-label" for="v_copago">Valor Copago</label>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="v_cuota" name="v_cuota"
                                                    for="v_cuota" placeholder="Valor Cuota">
                                                <label class="form-label" for="v_cuota">Valor Cuota</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
