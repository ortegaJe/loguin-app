...
@section('js')
    ...
    @vite(['resources/js/pages/cargo.manager.js'])
        ...
        <form id="main-form">
            <div class="row items-push">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="cargo" name="cargo"
                                            placeholder="Cargo">
                                        <label for="cargo">Ingrese nombre del cargo..</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="block block-rounded h-100 mb-0">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Tipo</h3>
                            <div class="block-options"></div>
                        </div>
                        <div class="block-content" id="block-tipo-cargo">
                            <div class="mb-4 p-4 px-4">
                                <div class="space-x-2" id="radio-tipo-cargo">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="admin" name="tipoCargo"
                                            value="1">
                                        <label class="form-check-label" for="admin">Administrativo</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="asistencial" name="tipoCargo"
                                            value="2">
                                        <label class="form-check-label" for="asistencial">Asistencial</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12 animated fadeIn" id="block-opciones-infra">
                    <div class="block block-rounded h-100 mb-0">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Opciones Infraestructura</h3>
                            <div class="block-options"></div>
                        </div>
                        <div class="block-content">
                            <div class="mb-4 p-4 px-4">
                                <div class="space-x-2" id="check-op-infra">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" value="1" id="correo"
                                            name="correo">
                                        <label class="form-check-label" for="correo">Correo Institucional</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" value="1" id="dominio"
                                            name="dominio">
                                        <label class="form-check-label" for="dominio">Usuario de Dominio</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" value="1" id="vpn"
                                            name="vpn">
                ...
                <div class="col-md-12 animated fadeIn" id="block-sedes">
                    <div class="block block-rounded h-100 mb-0">
                        <div class="block-header block-header-default">
                        ...
                        <div class="block-content">
                            <div class="mb-4 p-2" id="content-multi-select">
