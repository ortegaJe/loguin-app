...
@section('js')
    ...
    @vite(['resources/js/pages/datatables.perfiles.js'])
@endsection
    ...
    <div class="content">
        <div class="row">
            <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-shadow" href="javascript:void(0)" id="newPerfilBtn">
                    <div class="block-content block-content-full block-sticky-options">
                        ...
                        <div class="py-3 text-center">
                            ...
                            <div class="fs-sm fw-semibold text-uppercase text-muted">Nuevo Perfil</div>
                        </div>
                    </div>
                </a>
            </div>
        ...
        <div class="content-heading d-flex justify-content-between align-items-center">
            <span>
                Lista de Perfiles<small class="d-none d-sm-inline"></small>
            </span>
        </div>
        <!-- Partial Table -->
                ...
                <table class="table table-borderless table-hover table-striped table-vcenter js-dataTable-full"
                    ...
                    <thead class="text-end border-bottom">
                        <tr>
                            ...
                            <th class="text-center d-none d-sm-table-cell">Aplicacion</th>
            ...
            <div class="modal-dialog modal-dialog-popout modal-lg" role="document">
                <div class="modal-content">
                    <div class="block block-rounded shadow-none mb-0">
                        ...
                        <form id="perfilForm">
                            <div class="block-content" id="perfilContent"></div>
